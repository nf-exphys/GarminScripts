...
#All files from 08/20/2020 to 10/10/2020
...
FolderWithFitFiles <- "C:\\Users\\Nick.Foreman\\Desktop\\Nick Mobile Folders\\School\\2020-2021\\R Files\\Fit Files to be Read"
...
RawFitDF <- paste0(".\\FitDFRawImport", Sys.Date(), ".Rdata") #working directory is set as R files/GarminData
