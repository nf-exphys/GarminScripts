...
FolderWithFitFiles <- "C:\\Users\\Nick.Foreman\\Desktop\\Nick Mobile Folders\\School\\2020-2021\\R Files\\ExportedRunData\\Old Fit Files"
...
RawFitDF <- paste0("GarminData\\FitDFRawImport", Sys.Date(), ".Rdata")
...
cleanedFitDF <- paste0("GarminData\\FitDFCleaned", Sys.Date(), ".Rdata")
...
# Fill In Columns --------------------------------------------------
  ...
  # SumData -----------------------------------------------------------------
    load("GarminData\\sumdataNames.Rdata")
  ...
  # Device Info --------------------------------------------------------------
    load("GarminData\\deviceinfoNames.Rdata")
  ...
  # Event -------------------------------------------------------------------
    load("GarminData\\eventNames.Rdata")
  ...
  # Lap ---------------------------------------------------------------------
    load("GarminData\\LapNames.Rdata")
  ...
  # Record ------------------------------------------------------------------
    load("GarminData\\RecordNames.Rdata")
...
# Alphabetize Columns -----------------------------------------------------
 ...
 cleanSortFitDF <- paste0("GarminData\\FitDFCleanSort", Sys.Date(), ".Rdata")
